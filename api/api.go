...
import (
	...
	"github.com/ggquant/okex/api/rest"
	"github.com/ggquant/okex/api/ws"
)
...
func NewClient(ctx context.Context, apiKey, secretKey, passphrase string, destination okex.Destination) (*Client, error) {
	...
	case okex.BusinessServer:
		restURL = okex.BusinessRestURL
		wsPubURL = okex.BusinessPublicWsURL
		wsPriURL = okex.BusinessPrivateWsURL
	}
